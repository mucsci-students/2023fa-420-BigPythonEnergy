...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollingText.setGeometry(QtCore.QRect(380, 239, 200, 180))
        self.scrollingText.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 177, 178))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.foundWords = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.foundWords.setGeometry(QtCore.QRect(0, 0, 200, 180))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        self.foundWords.setFont(font)
        self.foundWords.setText("")
        self.foundWords.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.wrongInputLabel.setText(_translate("MainWindow", ""))
